...
const overrideMessage = [
  'WARNING! Your redis options maxRetriesPerRequest must be null',
  'and will be overridden by job-scheduler.',
].join(' ');
...
const upstashMessage =
  'job-scheduler: Upstash is not compatible with job-scheduler.';
...
export class RedisConnection extends EventEmitter {
  ...
  protected loadCommands(): Promise<void> {
    return (
      (<any>this._client)['job-scheduler:loadingCommands'] ||
      ((<any>this._client)['job-scheduler:loadingCommands'] = scriptLoader.load(
        this._client,
